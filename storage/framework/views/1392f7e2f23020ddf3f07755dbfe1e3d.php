...
<body>
    ...
    <nav>
        ...
        <div style="display: flex; justify-content: center; gap: 2rem;">
            ...
            <a href="<?php echo e(route('assignment.form')); ?>">Bike Assignment</a>
        </div>
    </nav>
    ...
    <div class="wrapper">
        <div class="form-container">
            ...
            <form action="<?php echo e(route('assignment.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
            ...
            <?php if(!$bike->riders->count()): ?> 
                <option value="<?php echo e($bike->id); ?>"><?php echo e($bike->plate_number); ?></option>
            <?php endif; ?>
...
<?php /**PATH C:\Laravel Code\Task\resources\views/assignment/form.blade.php ENDPATH**/ ?>