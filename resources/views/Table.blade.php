 ...
 <table class="container">
    <tr>
     ...
     <tr>
        ...
        <td id="view"><a href="{{route('view',$data->id)}}">View</a></td>
        <td id="delete"><a href="{{route('delete',$data->id)}}">Delete</a></td>
        <td id="update"><a href="{{route('update',$data->id)}}">Update</a></td>   
     </tr>
      @endforeach  
 </table>
</body>
